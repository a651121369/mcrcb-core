...
function createPrintPage(){
	...
	LODOP.PRINT_INIT("蒙城县卫生核算中心利息支出凭证");
	...
	LODOP.SET_PRINT_STYLEA(0,"Angle",1);
	LODOP.ADD_PRINT_TEXT(74,488,141,22,$('#voucher').text());
	LODOP.SET_PRINT_STYLEA(0,"Angle",1);
