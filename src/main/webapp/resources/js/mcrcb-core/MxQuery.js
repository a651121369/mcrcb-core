...
ConstructionForm = Ext.extend(Ext.ux.Form, {
    ...
    constructor: function() {
        this.beginTime = this.createDateField('<font color="red">*</font>开始日期','beginTime','Ymd','95%');
        this.endTime = this.createDateField('<font color="red">*</font>截至日期', 'endTime','Ymd','95%');
    	...
    	var customerBox=new Ext.form.ComboBox({
			   		...
			   		// typeAhead : true,
				   	 ...
				   	 store:new Ext.data.JsonStore({
    	                        proxy : new Ext.data.HttpProxy({
    	                               url : "/AccountManager/getSubAcctNo" ,
    	                               method : "POST"
    	                        }),
    	                        fields : [ 'acctId', 'acctName' ]
    	                 }),//定义数据源
        ...
        ConstructionForm.superclass.constructor.call(this, {
            ...
            items: [
                    ...
                    this.acctId1,this.acctId2
//                    {xtype:'fieldset', 'title':'明细账查询',collapsible : true,anchor:'100%',
//				layout: 'column',
//				items : [ {
//						columnWidth: .25,
//                    	anchor: '100%',
...
//		        ]}
     ...
     queryFormClick: function() {
     	...
     	if(beginTime1 == "" || endTime1 == "" || acctId1 == ""){
     		alert("查询条件不能为空");
     		return ;
     	}
