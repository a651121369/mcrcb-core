    	...
    	AuthResourceGrid.superclass.constructor.call(this, {
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),sm,
            	...
            	{header:'是否授权',dataIndex:'counter',width:80,sortable: true,
                	renderer:function(value){
                		if(value == 0) {
                			return "<span style='color:red;font-weight:bold;'>未授权1</span>";
                		}else if(value == 1) {
                			return "<span style='color:green;font-weight:bold;'>授权2</span>";
                		}else {
                			return value;
                		}
                	}
    ...
    constructor: function(height, width){
    	...
    	AuthUserGrid.superclass.constructor.call(this, {
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),sm,
            	...
            	{header:'登录账号2',dataIndex:'USERCODE',width:125,sortable: true},
