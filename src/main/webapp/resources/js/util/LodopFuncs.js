...
**************************/
var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='/resources/js/lodop/install_lodop32.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='/resources/js/lodop/install_lodop32.exe'>执行升级</a>,升级后请重新进入。</font>";
var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='/resources/js/lodop/install_lodop64.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='/resources/js/lodop/install_lodop64.exe'>执行升级</a>,升级后请重新进入。</font>";
var strHtmFireFox="<br><br><font color='#FF00FF'>注意：<br>1：如曾安装过Lodop旧版附件npActiveXPLugin,请在【工具】->【附加组件】->【扩展】中先卸它。";
	...
	try{		     
		...
		if (navigator.userAgent.indexOf('Win64')>=0){
	     ...
	     LODOP.SET_LICENSES("安徽联众软件技术有限公司","56BC490732E17DEBD0B594BBF683CAFE","安徽聯眾軟件技術有限公司","C3BECBFDD48D5EAC65BEF6BDE6F6C10C");
	     LODOP.SET_LICENSES("THIRD LICENSE","","AnHui Untech Co.,Ltd","476928E7686E82838FA31DBCC4DB10B7");
