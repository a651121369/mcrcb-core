...
WjwAccount = Ext.extend(Ext.ux.Form,{
	constructor: function(){
		...
		this.accParent = this.createTextField('上一级账户号3','accParent','95%','',null,32,'长度超过不能32');
...
WjwAccountGrid = Ext.extend(UxGrid,{
	constructor: function(height,width){
		...
		this.vcm = new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
		            ...
		            {header:'账户名称4',dataIndex:'custName',width:100,sortable:true,hidden:false},
		            ...
		            {header:'上一级账户号4',dataIndex:'accParent',width:100,sortable:true,hidden:false},
