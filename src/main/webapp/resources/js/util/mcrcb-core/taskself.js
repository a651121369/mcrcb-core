...
WjwPaymain = Ext.extend(Ext.ux.Form,{
	constructor: function(){
		...
		this.dspUserno = this.createTextField('待审批人','dspUserno','95%','',null,20,'长度超过不能20');
	...
	constructor: function(height,width){
		...
		this.vtbar = new Ext.Toolbar({
			items: [
			       ...
			       //'-',{xtype:'button',text:'审批',iconCls:'edit',handler:this.onModifyClick,scope:this}, 
			       //'-',{xtype:'button',text:'删除',iconCls:'delete',handler:this.onDeleteClick,scope:this},
					...
					//'-',{xtype:'label',text:'机构编号'},{xtype:'textfield',id:'unitNo'},
			       ...
			       '-',{xtype:'button',text:'查询',iconCls:'query',handler:function(){
					    	...
					    	var endTime = Ext.getCmp('endTime').getValue();
		    	   		    ...
		    	   		    wjwPaymainGrid.store.baseParams= {
		    	   					//unitNo:unitNo,
		    	   					connNo:connNo,startTime:startTime,endTime:endTime
		    	   			};
		    	   		    wjwPaymainGrid.store.load({params:{start:0,limit:PAGESIZE}});
	    	   			}
	       			},
		...
		this.vcm = new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
		           ...
		           // {header:'编号',dataIndex:'id',width:100,sortable:true,hidden:false},
		            ...
		            {header:'初审意见',dataIndex:'note1',width:200,sortable:true,hidden:false},
		            ...
		            {header:'复审意见',dataIndex:'note2',width:200,sortable:true,hidden:false},
